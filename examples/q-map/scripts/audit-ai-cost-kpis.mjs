...
function parseArgs(argv) {
  const out = {
    ...
    maxAvgEstimatedPromptTokens: asFiniteNumber(process.env.QMAP_AI_EVAL_MAX_AVG_ESTIMATED_PROMPT_TOKENS, 9000),
    maxP95EstimatedPromptTokens: asFiniteNumber(process.env.QMAP_AI_EVAL_MAX_P95_ESTIMATED_PROMPT_TOKENS, 18000),
    maxMaxEstimatedPromptTokens: asFiniteNumber(process.env.QMAP_AI_EVAL_MAX_MAX_ESTIMATED_PROMPT_TOKENS, 22000),
